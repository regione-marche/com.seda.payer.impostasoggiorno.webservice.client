/**
 * RecuperaFasceTariffeCsvRequest.java
 *
...
public class RecuperaFasceTariffeCsvRequest  implements java.io.Serializable {
    private com.seda.payer.impostasoggiorno.webservice.dati.TariffaImpostaSoggiorno tariffa;

    public RecuperaFasceTariffeCsvRequest() {
    }
    ...
    /**
     * Gets the tariffa value for this RecuperaFasceTariffeCsvRequest.
     * 
     * @return tariffa
     */
    ...
    /**
     * Sets the tariffa value for this RecuperaFasceTariffeCsvRequest.
     * 
     * @param tariffa
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RecuperaFasceTariffeCsvRequest)) return false;
        RecuperaFasceTariffeCsvRequest other = (RecuperaFasceTariffeCsvRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RecuperaFasceTariffeCsvRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dati.configurazione.webservice.impostasoggiorno.payer.seda.com", ">RecuperaFasceTariffeCsvRequest"));
