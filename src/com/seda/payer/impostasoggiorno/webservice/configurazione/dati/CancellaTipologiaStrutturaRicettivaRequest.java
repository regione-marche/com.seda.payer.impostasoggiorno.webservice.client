/**
 * CancellaTipologiaStrutturaRicettivaRequest.java
 *
...
public class CancellaTipologiaStrutturaRicettivaRequest  implements java.io.Serializable {
    private com.seda.payer.impostasoggiorno.webservice.dati.TipologiaStrutturaRicettiva tipologiaStrutturaRicettiva;

    public CancellaTipologiaStrutturaRicettivaRequest() {
    }
    ...
    /**
     * Gets the tipologiaStrutturaRicettiva value for this CancellaTipologiaStrutturaRicettivaRequest.
     * 
    ...
    /**
     * Sets the tipologiaStrutturaRicettiva value for this CancellaTipologiaStrutturaRicettivaRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CancellaTipologiaStrutturaRicettivaRequest)) return false;
        CancellaTipologiaStrutturaRicettivaRequest other = (CancellaTipologiaStrutturaRicettivaRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CancellaTipologiaStrutturaRicettivaRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dati.configurazione.webservice.impostasoggiorno.payer.seda.com", ">CancellaTipologiaStrutturaRicettivaRequest"));
