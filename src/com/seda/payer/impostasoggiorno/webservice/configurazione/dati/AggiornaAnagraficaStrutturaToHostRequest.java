/**
 * AggiornaAnagraficaStrutturaToHostRequest.java
 *
...
public class AggiornaAnagraficaStrutturaToHostRequest  implements java.io.Serializable {
    private com.seda.payer.impostasoggiorno.webservice.dati.AnagraficaStrutturaRicettiva anagraficaStruttura;

    private com.seda.payer.impostasoggiorno.webservice.configurazione.dati.AggiornaAnagraficaStrutturaToHostRequestTipoRichiesta tipoRichiesta;

    private java.lang.String descrizioneComune;

    private java.lang.String siglaProvincia;

    public AggiornaAnagraficaStrutturaToHostRequest() {
    }

    public AggiornaAnagraficaStrutturaToHostRequest(
           com.seda.payer.impostasoggiorno.webservice.dati.AnagraficaStrutturaRicettiva anagraficaStruttura,
           com.seda.payer.impostasoggiorno.webservice.configurazione.dati.AggiornaAnagraficaStrutturaToHostRequestTipoRichiesta tipoRichiesta,
    ...
    /**
     * Gets the anagraficaStruttura value for this AggiornaAnagraficaStrutturaToHostRequest.
     * 
    ...
    /**
     * Sets the anagraficaStruttura value for this AggiornaAnagraficaStrutturaToHostRequest.
     * 
    ...
    /**
     * Gets the tipoRichiesta value for this AggiornaAnagraficaStrutturaToHostRequest.
     * 
     * @return tipoRichiesta
     */
    public com.seda.payer.impostasoggiorno.webservice.configurazione.dati.AggiornaAnagraficaStrutturaToHostRequestTipoRichiesta getTipoRichiesta() {
        return tipoRichiesta;
    }


    /**
     * Sets the tipoRichiesta value for this AggiornaAnagraficaStrutturaToHostRequest.
     * 
     * @param tipoRichiesta
     */
    public void setTipoRichiesta(com.seda.payer.impostasoggiorno.webservice.configurazione.dati.AggiornaAnagraficaStrutturaToHostRequestTipoRichiesta tipoRichiesta) {
        this.tipoRichiesta = tipoRichiesta;
    }


    /**
     * Gets the descrizioneComune value for this AggiornaAnagraficaStrutturaToHostRequest.
     * 
    ...
    /**
     * Sets the descrizioneComune value for this AggiornaAnagraficaStrutturaToHostRequest.
     * 
    ...
    /**
     * Gets the siglaProvincia value for this AggiornaAnagraficaStrutturaToHostRequest.
     * 
    ...
    /**
     * Sets the siglaProvincia value for this AggiornaAnagraficaStrutturaToHostRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AggiornaAnagraficaStrutturaToHostRequest)) return false;
        AggiornaAnagraficaStrutturaToHostRequest other = (AggiornaAnagraficaStrutturaToHostRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AggiornaAnagraficaStrutturaToHostRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dati.configurazione.webservice.impostasoggiorno.payer.seda.com", ">AggiornaAnagraficaStrutturaToHostRequest"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://dati.configurazione.webservice.impostasoggiorno.payer.seda.com", "tipoRichiesta"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://dati.configurazione.webservice.impostasoggiorno.payer.seda.com", ">>AggiornaAnagraficaStrutturaToHostRequest>tipoRichiesta"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
