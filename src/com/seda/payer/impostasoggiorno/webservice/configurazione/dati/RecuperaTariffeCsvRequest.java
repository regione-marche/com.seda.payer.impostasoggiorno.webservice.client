/**
 * RecuperaTariffeCsvRequest.java
 *
...
public class RecuperaTariffeCsvRequest  implements java.io.Serializable {
    private com.seda.payer.impostasoggiorno.webservice.dati.TariffaImpostaSoggiorno tariffa;

    public RecuperaTariffeCsvRequest() {
    }
    ...
    /**
     * Gets the tariffa value for this RecuperaTariffeCsvRequest.
     * 
     * @return tariffa
     */
    ...
    /**
     * Sets the tariffa value for this RecuperaTariffeCsvRequest.
     * 
     * @param tariffa
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RecuperaTariffeCsvRequest)) return false;
        RecuperaTariffeCsvRequest other = (RecuperaTariffeCsvRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RecuperaTariffeCsvRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dati.configurazione.webservice.impostasoggiorno.payer.seda.com", ">RecuperaTariffeCsvRequest"));
