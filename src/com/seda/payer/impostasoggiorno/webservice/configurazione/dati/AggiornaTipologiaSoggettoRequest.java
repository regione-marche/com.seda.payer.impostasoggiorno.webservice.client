/**
 * AggiornaTipologiaSoggettoRequest.java
 *
...
public class AggiornaTipologiaSoggettoRequest  implements java.io.Serializable {
    private com.seda.payer.impostasoggiorno.webservice.dati.TipologiaSoggetto tipologiaSoggetto;

    public AggiornaTipologiaSoggettoRequest() {
    }
    ...
    /**
     * Gets the tipologiaSoggetto value for this AggiornaTipologiaSoggettoRequest.
     * 
    ...
    /**
     * Sets the tipologiaSoggetto value for this AggiornaTipologiaSoggettoRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AggiornaTipologiaSoggettoRequest)) return false;
        AggiornaTipologiaSoggettoRequest other = (AggiornaTipologiaSoggettoRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AggiornaTipologiaSoggettoRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dati.configurazione.webservice.impostasoggiorno.payer.seda.com", ">AggiornaTipologiaSoggettoRequest"));
