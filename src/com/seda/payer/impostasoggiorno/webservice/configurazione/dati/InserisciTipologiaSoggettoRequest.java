/**
 * InserisciTipologiaSoggettoRequest.java
 *
...
public class InserisciTipologiaSoggettoRequest  implements java.io.Serializable {
    private com.seda.payer.impostasoggiorno.webservice.dati.TipologiaSoggetto tipologiaSoggetto;

    public InserisciTipologiaSoggettoRequest() {
    }
    ...
    /**
     * Gets the tipologiaSoggetto value for this InserisciTipologiaSoggettoRequest.
     * 
    ...
    /**
     * Sets the tipologiaSoggetto value for this InserisciTipologiaSoggettoRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InserisciTipologiaSoggettoRequest)) return false;
        InserisciTipologiaSoggettoRequest other = (InserisciTipologiaSoggettoRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(InserisciTipologiaSoggettoRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dati.configurazione.webservice.impostasoggiorno.payer.seda.com", ">InserisciTipologiaSoggettoRequest"));
