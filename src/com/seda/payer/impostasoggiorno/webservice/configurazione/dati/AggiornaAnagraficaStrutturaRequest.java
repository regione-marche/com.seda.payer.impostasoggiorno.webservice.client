/**
 * AggiornaAnagraficaStrutturaRequest.java
 *
...
public class AggiornaAnagraficaStrutturaRequest  implements java.io.Serializable {
    private com.seda.payer.impostasoggiorno.webservice.dati.AnagraficaStrutturaRicettiva anagraficaStruttura;

    public AggiornaAnagraficaStrutturaRequest() {
    }
    ...
    /**
     * Gets the anagraficaStruttura value for this AggiornaAnagraficaStrutturaRequest.
     * 
    ...
    /**
     * Sets the anagraficaStruttura value for this AggiornaAnagraficaStrutturaRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AggiornaAnagraficaStrutturaRequest)) return false;
        AggiornaAnagraficaStrutturaRequest other = (AggiornaAnagraficaStrutturaRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AggiornaAnagraficaStrutturaRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dati.configurazione.webservice.impostasoggiorno.payer.seda.com", ">AggiornaAnagraficaStrutturaRequest"));
