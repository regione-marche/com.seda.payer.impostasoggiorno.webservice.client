/**
 * InserisciAnagraficaStrutturaRequest.java
 *
...
public class InserisciAnagraficaStrutturaRequest  implements java.io.Serializable {
    private com.seda.payer.impostasoggiorno.webservice.dati.AnagraficaStrutturaRicettiva anagraficaStruttura;

    public InserisciAnagraficaStrutturaRequest() {
    }
    ...
    /**
     * Gets the anagraficaStruttura value for this InserisciAnagraficaStrutturaRequest.
     * 
    ...
    /**
     * Sets the anagraficaStruttura value for this InserisciAnagraficaStrutturaRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InserisciAnagraficaStrutturaRequest)) return false;
        InserisciAnagraficaStrutturaRequest other = (InserisciAnagraficaStrutturaRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(InserisciAnagraficaStrutturaRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dati.configurazione.webservice.impostasoggiorno.payer.seda.com", ">InserisciAnagraficaStrutturaRequest"));
