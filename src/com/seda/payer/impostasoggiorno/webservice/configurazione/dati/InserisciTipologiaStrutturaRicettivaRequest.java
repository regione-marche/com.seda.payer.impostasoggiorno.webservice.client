/**
 * InserisciTipologiaStrutturaRicettivaRequest.java
 *
...
public class InserisciTipologiaStrutturaRicettivaRequest  implements java.io.Serializable {
    private com.seda.payer.impostasoggiorno.webservice.dati.TipologiaStrutturaRicettiva tipologiaStrutturaRicettiva;

    public InserisciTipologiaStrutturaRicettivaRequest() {
    }
    ...
    /**
     * Gets the tipologiaStrutturaRicettiva value for this InserisciTipologiaStrutturaRicettivaRequest.
     * 
    ...
    /**
     * Sets the tipologiaStrutturaRicettiva value for this InserisciTipologiaStrutturaRicettivaRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InserisciTipologiaStrutturaRicettivaRequest)) return false;
        InserisciTipologiaStrutturaRicettivaRequest other = (InserisciTipologiaStrutturaRicettivaRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(InserisciTipologiaStrutturaRicettivaRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dati.configurazione.webservice.impostasoggiorno.payer.seda.com", ">InserisciTipologiaStrutturaRicettivaRequest"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("tipologiaStrutturaRicettiva");
        elemField.setXmlName(new javax.xml.namespace.QName("http://dati.configurazione.webservice.impostasoggiorno.payer.seda.com", "tipologiaStrutturaRicettiva"));
