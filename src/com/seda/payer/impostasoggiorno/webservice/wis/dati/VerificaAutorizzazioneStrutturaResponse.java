/**
 * VerificaAutorizzazioneStrutturaResponse.java
 *
...
public class VerificaAutorizzazioneStrutturaResponse  implements java.io.Serializable {
    ...
    public VerificaAutorizzazioneStrutturaResponse() {
    }
    ...
    /**
     * Gets the anagraficaStruttura value for this VerificaAutorizzazioneStrutturaResponse.
     * 
    ...
    /**
     * Sets the anagraficaStruttura value for this VerificaAutorizzazioneStrutturaResponse.
     * 
    ...
    /**
     * Gets the retCode value for this VerificaAutorizzazioneStrutturaResponse.
     * 
     * @return retCode
     */
    ...
    /**
     * Sets the retCode value for this VerificaAutorizzazioneStrutturaResponse.
     * 
     * @param retCode
     */
    ...
    /**
     * Gets the retMessage value for this VerificaAutorizzazioneStrutturaResponse.
     * 
     * @return retMessage
     */
    ...
    /**
     * Sets the retMessage value for this VerificaAutorizzazioneStrutturaResponse.
     * 
     * @param retMessage
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof VerificaAutorizzazioneStrutturaResponse)) return false;
        VerificaAutorizzazioneStrutturaResponse other = (VerificaAutorizzazioneStrutturaResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VerificaAutorizzazioneStrutturaResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dati.wis.webservice.impostasoggiorno.payer.seda.com", ">VerificaAutorizzazioneStrutturaResponse"));
